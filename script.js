document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderCards() {
        ...
        categoryData.category_products.forEach(product => {
            ...
            // Split the title into words and truncate if necessary
    ...
    // Function to show only the clicked image
    function showImage(activeImageId) {
        // Get all the images
        const images = document.querySelectorAll('.choices-btn-group button img');
    ...
    categoryButtons.forEach(button => {
        ...
        if (button.textContent.trim() === currentCategory) {
            ...
            showImage(button.querySelector('img').id);  // Show the image of the selected button
        }
        ...
        button.addEventListener('click', function () {
            ...
            if (isSelected) {
                ...
                showImage('');  // Hide all images
            } else {
                // Select the clicked button
                this.classList.add('selected');
                currentCategory = this.textContent.trim();
                localStorage.setItem('selectedCategory', currentCategory);
                showImage(this.querySelector('img').id);  // Show the image of the selected button
            }
